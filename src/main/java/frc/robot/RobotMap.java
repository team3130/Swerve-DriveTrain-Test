...
public class RobotMap {
    ...
    public static final int CAN_RIGHTMOTORFRONTSpinnn = 2;
    public static final int CAN_RIGHTMOTORREARSpinnn = 3;
    public static final int CAN_LEFTMOTORFRONTSpinnn = 4;
    public static final int CAN_LEFTMOTORREARSpinnn = 5;

    public static final int CAN_RIGHTMOTORFRONTBrrrrrrrr = 6;
    public static final int CAN_RIGHTMOTORREARBrrrrrrrr= 7;
    public static final int CAN_LEFTMOTORFRONTBrrrrrrrr = 8;
    public static final int CAN_LEFTMOTORREARBrrrrrrrr= 9;
